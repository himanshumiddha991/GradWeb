                            ...
                            @foreach($games as $index => $g)
                                ...
                                <td class="yesterday-number">
                                    <h3>
                                     ...
                                     @php
                                        echo App\Http\Controllers\Admin\ScraperController::scrape($g->third_party_index,0);
                                    @endphp    
                                ...
                                <td class="today-number">
                                    ...
                                    @php
                                        echo App\Http\Controllers\Admin\ScraperController::scrape($g->third_party_index,1);
                                    @endphp    
                               ...
                               <th class="yesterday-date">
                                ...
                                <td class="yesterday-number">
                                    <h3>
                                         ...
                                         @php
                                            echo is_null($g->third_party_index)?'--':App\Http\Controllers\Admin\ScraperController::scrape($g->third_party_index,0);
                                        @endphp    
                                    <!-- {{is_null($g->previous)?"XX":($g->previous->number<10?'0'.$g->previous->number:$g->previous->number)}}</h3> -->
                                </td>
                                <td class="today-number">
                                    <h3>
                                        ...
                                        @php
                                            echo  is_null($g->third_party_index)?'--':App\Http\Controllers\Admin\ScraperController::scrape($g->third_party_index,1);
                                        @endphp 
                                    <!-- {{is_null($g->current)?"XX":($g->current->number<10?'0'.$g->current->number:$g->current->number)}}</h3> -->
                                </td>
                            </tr>
